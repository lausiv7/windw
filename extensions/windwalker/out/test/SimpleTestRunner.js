...
class SimpleTestRunner {
    ...
    runBasicTests() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // 기본 환경 테스트
                yield this.testEnvironment();
                yield this.testFileSystem();
                yield this.testGitBasics();
                yield this.testIndexedDBBasics();
                yield this.testServiceBasics();
                // 통합 테스트
                yield this.testMessageFlow();
                yield this.testConversationFlow();
            }
            catch (error) {
            ...
            // 대시보드 생성
            yield this.generateSimpleDashboard(report);
            return report;
        });
    }
    testEnvironment() {
    ...
    testFileSystem() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield fs.writeFile(testFile, testContent, 'utf8');
                const readContent = yield fs.readFile(testFile, 'utf8');
    ...
    testGitBasics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { stdout, stderr } = yield execAsync('git status --porcelain', { cwd: workspacePath });
    ...
    testMessageFlow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // 메시지 처리 시뮬레이션
                const processed = yield this.simulateMessageProcessing(mockMessage);
    ...
    testConversationFlow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const saved = yield this.simulateConversationSave(conversationData);
    ...
    simulateMessageProcessing(message) {
        return __awaiter(this, void 0, void 0, function* () {
            // 메시지 처리 로직 시뮬레이션
            yield new Promise(resolve => setTimeout(resolve, 100)); // 처리 지연 시뮬레이션
            return message.type && message.data && message.timestamp;
        });
    }
    simulateConversationSave(conversation) {
        return __awaiter(this, void 0, void 0, function* () {
            // 대화 저장 로직 시뮬레이션
    ...
    generateSimpleDashboard(report) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield fs.mkdir(this.outputDir, { recursive: true });
    ...
    <script>
        function toggleDetails(testName) {
            ...
            if (element.style.display === 'none' || element.style.display === '') {
                ...
                const choice = yield vscode.window.showInformationMessage(`🎯 WindWalker 테스트 완료! 결과: ${report.passed}/${report.totalTests} 성공`, '대시보드 열기');
                if (choice === '대시보드 열기') {
                    yield vscode.env.openExternal(vscode.Uri.file(dashboardPath));
                }
