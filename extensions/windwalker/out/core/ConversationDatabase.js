...
class ConversationDatabase {
     ...
     * 새 대화 세션 생성
     */
    createConversation(userId, projectType, initialContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.db)
     ...
     * 메시지 저장 (AI/사용자 구분)
     */
    saveMessage(conversationId, sender, content, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.db)
                throw new Error('Database not initialized');
            ...
            return new Promise((resolve, reject) => {
                ...
                messageRequest.onsuccess = () => __awaiter(this, void 0, void 0, function* () {
                    // 대화 세션 통계 업데이트
     ...
     * Git 커밋과 대화 연결 저장
     */
    linkGitCommit(conversationId, messageId, gitCommitResult, changeDescription) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.db)
                throw new Error('Database not initialized');
     ...
     * 대화 히스토리 조회 (개인화용)
     */
    getUserConversationHistory(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, limit = 50, projectType) {
            if (!this.db)
                throw new Error('Database not initialized');
            return new Promise((resolve, reject) => {
    ...
    analyzeUserPatterns(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.db)
                throw new Error('Database not initialized');
            const conversations = yield this.getUserConversationHistory(userId, 100);
            const messages = yield this.getUserMessages(userId, 500);
            // 1. 선호 프로젝트 타입 분석
     ...
     * 사용자 패턴 저장
     */
    saveUserPatterns(userId, patterns) {
        return __awaiter(this, void 0, void 0, function* () {
            // 패턴 저장 로직 구현 (필요시)
    ...
    getUserMessages(userId, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const conv of conversations.slice(0, 10)) { // 최근 10개 대화만
                const messages = yield this.getConversationMessages(conv.conversationId);
