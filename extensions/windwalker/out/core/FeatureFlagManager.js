...
class FeatureFlagManager {
    ...
    registerFlag(flag) {
        ...
        this.flags.set(flag.name, Object.assign({}, flag));
    ...
    isEnabled(flagName, userContext) {
        ...
        const currentUserContext = Object.assign(Object.assign({}, this.userContext), userContext);
        // 환경 필터 확인
    ...
    exportConfiguration() {
        ...
        for (const [name, flag] of this.flags) {
            flags[name] = Object.assign({}, flag);
        }
        return Object.assign(Object.assign({}, this.config), { flags });
    }
    /**
     * 기능 플래그 설정 가져오기
     */
    importConfiguration(config) {
        ...
        for (const [name, flag] of Object.entries(config.flags)) {
            this.flags.set(name, Object.assign({}, flag));
        }
