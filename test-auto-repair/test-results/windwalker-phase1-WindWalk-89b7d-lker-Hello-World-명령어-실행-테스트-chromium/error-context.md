...
- application:
  ...
  - toolbar
  - toolbar
  - 'textbox "Search files by name (append : to go to line or @ to go to symbol)"': "WindWalker: Hello World"
  - text: 1 Results
  - toolbar
  - progressbar
  - 'listbox "Search files by name (append : to go to line or @ to go to symbol)"':
    - option "No matching results"
```